...
contract Desafio_4 {
    ...
    function creaSubasta(uint256 _startTime, uint256 _endTime) public payable {
        //Verificación de monto de creación
        ...
        //Agregamos a lista subastasActivas
        subastasActivas.push(_auctionId);

        //Agregamos a mappin de idSubasta y su index en el array, 
        //luego actualizamos el contador del index
        auctionIndex[_auctionId] = indexCounter;
        indexCounter++;
        
        //Instanciamos un struct Auction y asociamos al mappin mapping auctions
        Auction storage auction = auctions[_auctionId];

        auction.startTime = _startTime;
        auction.endTime = _endTime;

        //Emitimos evento de creación de subasta 
    ...
    function proponerOferta(bytes32 _auctionId) public payable {
        ...
        if(msg.value < auction.highestBid){
            ...
            //Agrega 5 minutos si se hace oferta en los últimos 5 minutos
    ...
    function finalizarSubasta(bytes32 _auctionId) public {
        ...
        subastasActivas[auctionIndex[_auctionId]] = subastasActivas[subastasActivas.length -1];
        ...
        subastasPasadas.push(_auctionId);
    ...
    function recuperarOferta(bytes32 _auctionId) public {
        ...
        uint256 cantidadParaRecuperar = auction.offers[msg.sender];
        auction.offers[msg.sender] = 0;
        payable(msg.sender).transfer(cantidadParaRecuperar);
