...
contract Desafio_1 {
    ...
    function guardarActivoSimple(address _billetera, uint256 _cantidad) public  {
        require(_billetera != address(0), "El address no puede ser 0x00");

        activosSimple[_billetera] = _cantidad;
    }
